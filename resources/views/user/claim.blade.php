...
@section('content')
    ...
    @if ($userClaim)
        <x-card title="Your Claim Status">
            ...
            <span class="text-xs text-gray-500">* If you want to claim another restaurant, please contact <a class="text-primary hover:underline" href="mailto:support@fudz.my.id">support@fudz.my.id</a>.</span>
        </x-card>
    @endif
