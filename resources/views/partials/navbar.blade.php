                    ...
                    <div id="dropdownAvatar" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow-sm w-44">
                        ...
                        <div class="py-2">
                            <form method="POST" action="{{ route('logout') }}">
                                @csrf
                                <button type="submit" class="block px-4 py-2 text-sm text-black hover:bg-gray-100">Sign out</button>
                            </form>
                        </div>
                    </div>
                @else
                    ...
                    <a href="{{ route('login') }}" class="px-4 py-2 bg-primary text-white rounded-lg hover:bg-primary-dark transition text-sm">Login</a>
                @endauth
