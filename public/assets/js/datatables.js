 ...
 *   https://datatables.net/download/#ju/dt-2.3.0
 *
 * Included libraries:
 *  DataTables 2.3.0
 */
...
!(function (n) {
    ...
    var T,
        ...
        d =
            ...
            H.extend(V.ext.classes, {
                ...
                scrolling: {
                    body: "dt-scroll-body",
                    container: "dt-scroll border-2 rounded-lg border-light/50",
                    footer: {
                        self: "dt-scroll-foot",
        ...
        (X.register = r =
            function (e, t) {
                if (Array.isArray(e))
                    ...
                    for (
                        var a = e.split("."), o = st, i = 0, l = a.length;
                        i < l;
                        i++
                    ) {
                        var s,
                        ...
                        function (n) {
                            ...
                            if ("function" == typeof n)
                                return (
                                    (r = Dt(i, l)),
                                    c.map(function (e, t) {
                                        return n(t, mt(i, t, 0, 0, r), vt(i, t))
                                            ? t
                                            : null;
                                    })
                                );
    ...
    r("cells()", function (g, e, m) {
        ...
        (V.defaults = {
            ...
            oLanguage: {
                oAria: {
                    orderable: ": Aktifkan untuk mengurutkan",
                    orderableReverse: ": Aktifkan untuk membalik urutan",
                    orderableRemove: ": Aktifkan untuk menghapus pengurutan",
                    paginate: {
                        first: "Pertama",
                        last: "Terakhir",
                        next: "Berikutnya",
                    ...
                    return (
                        ...
                        a && o.push(e.disabled),
                        {
                            display: (r =
                                "ellipsis" === t
                                    ? H(
                                          '<span class="ellipsis pagelink"></span>'
                                      ).html(n)[0]
                                    : H("<button>", {
                                          class: o.join(" "),
                                          role: "link",
    ...
    "function" == typeof define && define.amd
        ...
        ? ((u = require("jquery")),
          ...
          "undefined" == typeof window
              ...
              : (i(window, u),
                (module.exports = n(u, window, window.document))))
